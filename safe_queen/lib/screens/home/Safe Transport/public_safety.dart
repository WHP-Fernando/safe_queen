...
void main() {
  runApp(PublicSafetyTransport());
}

class PublicSafetyTransport extends StatelessWidget {
  @override
          ...
          SizedBox(
            ...
            child: InAppWebView(
              initialUrlRequest: URLRequest(
                url: WebUri(
                  Uri.parse('https://streetsafethinking.com/a-guide-to-female-safety-on-public-transport/').toString(),
                ),
              ),
